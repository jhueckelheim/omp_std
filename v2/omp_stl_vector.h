// originally from /soft/compilers/gcc/12.2.0/x86_64-suse-linux/lib/gcc/x86_64-pc-linux-gnu/12.2.0/../../../../include/c++/12.2.0/bits/stl_vector.h
...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
  ...
  template<typename _Tp, typename _Alloc>
	...
	_M_swap_data(_Vector_impl_data& __x) _GLIBCXX_NOEXCEPT
	{
      ...
      #pragma omp declare mapper(_Vector_impl_data v) map(tofrom: v._M_start[0:(v._M_finish-v._M_start)])
